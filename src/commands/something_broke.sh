...
↳ Path: $_prog_path
Variables
$(atfile.something_broke.print_envvar "DEBUG")
$(atfile.something_broke.print_envvar "DEVEL")
$(atfile.something_broke.print_envvar "DEVEL_DIR")
↳ ${_envvar_prefix}_DEVEL_DIST_PASSWORD: $([[ -n $(atfile.util.get_envvar "${_envvar_prefix}_DEVEL_DIST_PASSWORD") ]] && echo "(Set)")
$(atfile.something_broke.print_envvar "DEVEL_DIST_USERNAME" "$_devel_dist_username_default")
$(atfile.something_broke.print_envvar "DEVEL_ENABLE_PIPING" "0")
$(atfile.something_broke.print_envvar "DEVEL_ENABLE_PUBLISH" "$_devel_enable_publish_default")
$(atfile.something_broke.print_envvar "DEVEL_ENTRY")
↳ ${_envvar_prefix}_DEVEL_INCLUDES:
$(for s in "${ATFILE_DEVEL_INCLUDES[@]}"; do echo " ↳ $s"; done)
$(atfile.something_broke.print_envvar "DEVEL_SOURCE")
$(atfile.something_broke.print_envvar "DISABLE_AUTH_CHECK" "$_disable_auth_check_default")
$(atfile.something_broke.print_envvar "DISABLE_NI_EXIFTOOL" "$_disable_ni_exiftool_default")
$(atfile.something_broke.print_envvar "DISABLE_NI_MD5SUM" "$_disable_ni_md5sum_default")
$(atfile.something_broke.print_envvar "DISABLE_NI_MEDIAINFO" "$_disable_ni_mediainfo_default")
$(atfile.something_broke.print_envvar "DISABLE_SETUP_DIR_CREATION" "$_disable_setup_dir_creation_default")
$(atfile.something_broke.print_envvar "DISABLE_UNSUPPORTED_OS_WARN" "$_disable_unsupported_os_warn")
$(atfile.something_broke.print_envvar "DISABLE_UPDATE_CHECKING" "$_disable_update_checking_default")
$(atfile.something_broke.print_envvar "DISABLE_UPDATE_COMMAND" "$_disable_update_command_default")
...
$(atfile.something_broke.print_envvar "PATH_HOOK_PATH_POST_START")
$(atfile.something_broke.print_envvar "PATH_HOOK_PATH_PRE_EXIT")
$(atfile.something_broke.print_envvar "PATH_HOOK_PRE_START")
