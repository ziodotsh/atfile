...
$(atfile.something_broke.print_envvar "HOOK_POST_START_PATH")
$(atfile.something_broke.print_envvar "HOOK_PRE_EXIT_PATH")
$(atfile.something_broke.print_envvar "HOOK_PRE_START_PATH")
